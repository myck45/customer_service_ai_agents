...
type BotUtils interface {
	...
	BotToolsHandler(functionName string, data string, restaurantID uint) (string, error)

	// HandleGetUserOrder Wraper for handle GetUserOrder function
	HandleGetUserOrder(data string, restaurantID uint) (string, error)

	// HandleGetMenuItemsFromImage Wraper for handle GetMenuItemsFromImage function
	HandleGetMenuItemsFromImage(data string, restaurantID uint) (string, error)
