...
resource "aws_api_gateway_deployment" "restaurant_menu_api_gateway_deployment" {
  depends_on = [
    ...
    aws_api_gateway_integration.menu_files_integration_post,
    aws_api_gateway_integration.menu_files_integration_delete,
    aws_api_gateway_integration.menu_files_integration_get_by_id,
    aws_api_gateway_integration.menu_files_integration_get_by_restaurant_id,
    aws_api_gateway_integration.menu_files_integration_put,
  ]
  ...
  triggers = {
    redeployment = sha1(jsonencode({
      ...
      menu_files_integration_post                 = aws_api_gateway_integration.menu_files_integration_post.id,
      menu_files_integration_delete               = aws_api_gateway_integration.menu_files_integration_delete.id,
      menu_files_integration_get_by_id            = aws_api_gateway_integration.menu_files_integration_get_by_id.id,
      menu_files_integration_get_by_restaurant_id = aws_api_gateway_integration.menu_files_integration_get_by_restaurant_id.id,
      menu_files_integration_put                  = aws_api_gateway_integration.menu_files_integration_put.id,
    }))
  }
